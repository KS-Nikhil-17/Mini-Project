...
df_orders = spark.table("spark_tables.orders_pq")
df_customers = spark.table("spark_tables.customers_pq")
...
df_orders_grouped = df_orders_delivered.groupBy("customer_id").agg( count("*").alias("customer_order_history"))
